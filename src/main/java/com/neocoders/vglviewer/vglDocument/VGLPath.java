...
public class VGLPath implements VGLElement {
    public VGLPath(VGLProperties properties, VGLPoints points) {
    ...
    /** Try to pick this path; returns true if picked else false */
